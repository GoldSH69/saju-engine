 ...
 * 해석 템플릿 통합 모듈
 *
 * 5개 개별 템플릿을 통합하여 하나의 함수로 전체 해석을 생성합니다.
 *
 * 사용:
 ...
 *   const interp = generateInterpretation(sajuResult)
 *   console.log(interp.dayStem?.short)        // 무료 해석
 *   console.log(interp.dayStem?.detail)        // 광고/유료 해석
 *   console.log(interp.dailyFortune?.short)    // 오늘의 운세
 */
